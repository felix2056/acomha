<div class="header-top-area" id="scroolup">
    ...
    <!--MAINMENU AREA-->
    <div id="mainmenu-area-sticky-wrapper" class="sticky-wrapper" style="height: 100px;">
        <div class="mainmenu-area" id="mainmenu-area" style="width: 1349px;">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div id="main-nav" class="stellarnav dark desktop"><a href="#" class="menu-toggle full"><i
                                        class="fa fa-bars"></i></a>
                                <div class="search-form-buton">
