    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
                <div class="single-gallery-four">
                    <div class="single-gallery-details mb30">
                        <div class="gallery-img">
                            <img src="assets/img/gallery/gallery-1.jpg" alt="">
                        </div>
                        <div class="gallery-details">
                            <div class="gallery-view-details">
                                <a class="gallery-big-thumb" href="assets/img/gallery/gallery-1.jpg"
                                    data-effect="mfp-zoom-in"><i class="fa fa-expand"></i></a>
                            </div>
                            <h4>Poor Education</h4>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
                <div class="single-gallery-four">
                    <div class="single-gallery-details mb30">
                        ...
                        <div class="gallery-details">
                            <div class="gallery-view-details">
                                <a class="gallery-big-thumb" href="assets/img/gallery/gallery-2.jpg"
                                    data-effect="mfp-zoom-in"><i class="fa fa-expand"></i></a>
                            </div>
                            <h4>Poor Education</h4>
                        </div>
            ...
            <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
                <div class="single-gallery-four">
                    <div class="single-gallery-details mb30">
                        ...
                        <div class="gallery-details">
                            <div class="gallery-view-details">
                                <a class="gallery-big-thumb" href="assets/img/gallery/gallery-3.jpg"
                                    data-effect="mfp-zoom-in"><i class="fa fa-expand"></i></a>
                            </div>
                            <h4>Poor Education</h4>
                        </div>
            ...
            <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
                <div class="single-gallery-four">
                    <div class="single-gallery-details mb30">
                        ...
                        <div class="gallery-details">
                            <div class="gallery-view-details">
                                <a class="gallery-big-thumb" href="assets/img/gallery/gallery-4.jpg"
                                    data-effect="mfp-zoom-in"><i class="fa fa-expand"></i></a>
                            </div>
                            <h4>Poor Education</h4>
                        </div>
            ...
            <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
                <div class="single-gallery-four">
                    <div class="single-gallery-details mb30">
                        ...
                        <div class="gallery-details">
                            <div class="gallery-view-details">
                                <a class="gallery-big-thumb" href="assets/img/gallery/gallery-5.jpg"
                                    data-effect="mfp-zoom-in"><i class="fa fa-expand"></i></a>
                            </div>
                            <h4>Poor Education</h4>
                        </div>
            ...
            <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
                <div class="single-gallery-four">
                    <div class="single-gallery-details mb30">
                        ...
                        <div class="gallery-details">
                            <div class="gallery-view-details">
                                <a class="gallery-big-thumb" href="assets/img/gallery/gallery-6.jpg"
                                    data-effect="mfp-zoom-in"><i class="fa fa-expand"></i></a>
                            </div>
                            <h4>Poor Education</h4>
                        </div>
...
<section class="call-to-action-area section-padding relative">
    <div class="area-bg" data-stellar-background-ratio="0.6" style="background-position: 50% 50%;"></div>
    <div class="container">
        <div class="row flex-v-center">
            <div class="col-md-8">
                <div class="call-to-action-two padding50 white xs-padding0 xs-mb30 xs-center">
                    <div class="call-to-action-details">
                        <p class="subhidding">request a call back</p>
                        <h2>It’s time to Make the World Better Together</h2>
...
<!--VOLUNTEER ARAE-->
<section class="volunteer-area relative section-padding">
    <div class="area-bg"></div>
    <div class="container-fluid no-padding">
        <div class="row no-margin">
            <div class="col-md-12 relative inner-bg section-padding">
                <div class="area-bg"></div>
                <div class="container">
                    <div class="row">
                        <div class="col-md-7 col-lg-6">
                            <div class="call-to-action white">
                                <h3 class="font48 xs-font26">Are you Ready to Join our volunteer Team?</h3>
                                <a href="#" class="read-more">Become a Volunteer</a>
                            </div>
                        </div>
                    </div>
                </div>
